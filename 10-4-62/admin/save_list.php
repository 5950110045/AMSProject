...
<span style="font-size:11pt; font-weight:bold;">บันทึกรายการพัสดุ ( Save Article List)</span><br><br>
	<table style="width:100%; border: 1px solid #eeeeee; ">
		...
		<p> รหัสพัสดุ :<input type="text" name="atc_id" size=30
						required="require" placeholder="Enter Article ID" autocomplete="off">
		<p> ชื่อพัสดุ :<input type="text" name="atc_name" size=30 required="require"
		...
		<p>หน่วยนับ : <select name="unit_id" id="unit_id">
			 ...
			 <p> ประเภทพัสดุ :<select name="category_id">
			 <?php
