	...
	<div id="header">
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href='../admin/save_type.php' accesskey='31' title=''>บันทึกประเภทพัสดุ<br><span class='enrightlink'>Save Article Type</span></a></li>
...
<span style="font-size:11pt; font-weight:bold;">บันทึกประเภทพัสดุ( Save Article Type)</span><br><br>
	<table style="width:100%; border: 1px solid #eeeeee; ">
        ...
        <!--<form action="save_typeart.php" method="post">
		 <fieldset><br>
		 <legend>บันทึกประเภทพัสดุ</legend>
		...
		<input type="reset" id="myreset" value="รีเซ็ต"><br>
		</form><br>-->
		<fieldset><br>
		 <legend>บันทึกประเภทพัสดุ</legend>
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">เพิ่มประเภทพัสดุ</button>
		 </fieldset>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">เพิ่มประเภทพัสดุ</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="../admin/save_typeart.php" method="POST">
          <div class="form-group">
            <label for="category_id" class="col-form-label">รหัสประเภท:</label>
            <textarea class="form-control" name="category_id" id="category_id"></textarea>
          </div>
          <div class="form-group">
            <label for="category_name" class="col-form-label">ชื่อประเภท:</label>
            <textarea class="form-control" name="category_name" id="category_name"></textarea>
          </div>
