	...
	<div id="header">
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href='../admin/save_unit.php' accesskey='33' title=''>บันทึกหน่วยนับพัสดุ<br><span class='enrightlink'>Save Article Unit</span></a></li>
...
<span style="font-size:11pt; font-weight:bold;">บันทึกหน่วยนับ ( Save Article Unit)</span><br><br>
	<table style="width:100%; border: 1px solid #eeeeee; ">
		...
		<fieldset><br>
		 <legend>บันทึกหน่วยนับพัสดุ</legend>
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">เพิ่มประเภทพัสดุ</button><br><br>
		 
		 <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		 <div class="modal-dialog" role="document">
			 <div class="modal-content">
				 <div class="modal-header">
					 <h5 class="modal-title" id="exampleModalLabel">เพิ่มหน่วยนับพัสดุ</h5>
					 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
						 <span aria-hidden="true">&times;</span>
					 </button>
				 </div>
				 <div class="modal-body">
					 <form action="../admin/save_unitart.php" method="POST">
						 <div class="form-group">
							 <label for="unit_id" class="col-form-label">รหัสหน่วยนับ:</label>
							 <textarea class="form-control" name="unit_id" id="unit_id"></textarea>
						 </div>
						 <div class="form-group">
							 <label for="unit_name" class="col-form-label">ชื่อหน่วยนับ:</label>
							 <textarea class="form-control" name="unit_name" id="unit_name"></textarea>
						 </div>
