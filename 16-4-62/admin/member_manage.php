	...
	<div id="header">
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href='../admin/member_manage.php' accesskey='43' title=''>จัดการข้อมูลสมาชิก<br><span class='enrightlink'>Member Management</span></a></li>
...
<span style="font-size:11pt; font-weight:bold;">จัดการข้อมูลสมาชิก ( Member Management)</span><br><br>
	<table style="width:100%; border: 1px solid #eeeeee; ">
		...
		<p><span class="header"></span></p><br>
        <a href='../Login/signup.php' title='เพิ่มข้อมูลบุคลากร'>เพิ่มสมาชิก</a><br><br>
		
		<?php
require('../Login/connect.php');

$query = "SELECT*FROM user where usertype='M' ";
...
echo "<tr><th>รหัสบุคลากร</th><th>username</th><th>Password</th><th>ชื่อบุคลากร</th><th>นามสกุล</th><th>เบอร์</th><th colspan='2'>เลือกทำงาน</th></tr>";
while($row =$result->fetch(PDO::FETCH_ASSOC)){
	//แสดงข้อมูลในแต่ละแถวของตาราง
	
	echo "<td>",$row['mem_id'],"</td>\n";
	echo "<td>",$row['mem_user'],"</td>\n";
...
echo "<td><a href=\"....php?mem_id=$mem_id\">แก้ไข</a></td>\n";
//สร้าง link ไปยังโปรแกรม php ที่ทำหน้าที่ลบข้อมูลรพร้อมส่งรหัสแผนกหัสแผนก
echo "<td><a href=\"../admin/del_user.php?mem_id=$mem_id\" onclick=\"return confirm('คุณต้องการลบ บัญชีบุคลากรจริงหรือไม่@?')\">ลบ</a></td>\n";
echo "\t</tr>\n";
}
echo "</table><br>";
