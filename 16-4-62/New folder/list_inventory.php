...
<div  class="container">
	<div id="header">
		<div id="logo">
			...
			<a href="../admin/list_inventory.php" style="font-size:12pt">ระบบจัดการพัสดุ</a><br>
			<span><a href="../admin/list_inventory.php" rel="nofollow" style="font-size:10pt">Article Management System</a></span>
		</div>
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href='../admin/list_inventory.php' accesskey='1' title=''>รายการพัสดุ<br><span class='enrightlink'> Inventory List</span></a></li>
				...
				<li><a href='../admin/save_list.php' accesskey='32' title=''>บันทึกรายการพัสดุ<br><span class='enrightlink'>Save Article List</span></a></li>
