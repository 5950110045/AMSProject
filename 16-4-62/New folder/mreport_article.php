		...
		<div id="menu">
			<ul>
				...
				<li><a href='../admin/save_unit.php' accesskey='33' title=''>บันทึกหน่วยนับพัสดุ<br><span class='enrightlink'>Save Article Unit</span></a></li>
						<li class="current_page_item"><a href='../admin/mreport_article.php' accesskey='41' title=''>รายงานพัสดุประจำเดือน<br><span class='enrightlink'>Monthly Article Report</span></a></li>
				...
				<li><a href="logout.php"  onclick="return confirm('ยืนยันการออกจากระบบ')" accesskey="5" title="">ออกจากระบบ<br><span class="enrightlink">Log out</span></a></li>
